...
public class Main {
        ...
        public static void main(String[] args) throws Exception {
            System.out.println("ВВедите два целых числа от 1 до 10 и арифметическое действие");
            ...
            if ((n1 == -1 && n2 > -1 )||(n2 == -1 && n1 > -1)) {
                throw new Exception("Ввод римских и арабских чисел одновременно невозможен");
            }
            if (n1 < 0 && n2 < 0) {
                result = 0;
            } else {
